...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="index3.html" class="brand-link" style="background-color: rgb(118, 114, 0); color: black">
      <span class="brand-text font-weight-light"><b>Admin Paneli</b></span>
    </a>
  
    <!-- Sidebar -->
    <div class="sidebar" style="background-color: rgb(51, 31, 100); color: black">
